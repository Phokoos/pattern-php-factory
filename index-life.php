...
class FacebookConnector implements SocialNetworkConnector
{
    ...
    public function createPost($content): void
    {
        echo "Send HTTP API requests to create a post in Facebook timeline Facebook: $content\n";
    }
}
...
class LinkedInConnector implements SocialNetworkConnector
{
    ...
    public function createPost($content): void
    {
        echo "Send HTTP API requests to create a post in LinkedIn timeline. LinkedIn: $content\n";
    }
}
